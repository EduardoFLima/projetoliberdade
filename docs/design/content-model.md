...
> **Note:** This is the living reference for the content model, copied from the
> original design spec at `docs/superpowers/specs/2026-06-30-content-json-redesign-design.md`.
> The design below is authoritative, but paths reflect the spec's original context:
> the live content file the app bundles is **`src/content/content.json`** (not
> `docs/resources/content.json`).

**Date:** 2026-06-30
**Status:** Approved (design); ready for implementation planning
**File affected:** `docs/resources/content.json` (now `src/content/content.json` — see note above)
